...
import (
	...
	wlogzap "github.com/palantir/witchcraft-go-logging/v2/wlog-zap"
	zapimpl "github.com/palantir/witchcraft-go-logging/v2/wlog-zap/internal"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/auditlog/audit2log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/auditlog/audit2log/audit2logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/auditlog/audit3log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/auditlog/audit3log/audit3logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/diaglog/diag1log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/diaglog/diag1log/diag1logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/evtlog/evt2log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/evtlog/evt2log/evt2logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/metriclog/metric1log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/metriclog/metric1log/metric1logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/reqlog/req2log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/reqlog/req2log/req2logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/svclog/svc1log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/svclog/svc1log/svc1logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/trclog/trc1log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/trclog/trc1log/trc1logtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/wlogtests"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/wrappedlog/wrapped1log"
	"github.com/palantir/witchcraft-go-logging/v2/wlog/wrappedlog/wrapped1log/wrapped1logtests"
)
...
func TestAudit3LogDualLogToAudit2Log(t *testing.T) {
	audit3logtests.DualLoggingJSONTestSuite(t, func(audit3Writer, audit2Writer io.Writer) audit3log.Logger {
		return audit3log.NewDualLoggerFromCreator(
			audit3Writer,
			audit2Writer,
			zapimpl.LoggerProvider().NewLogger,
		)
