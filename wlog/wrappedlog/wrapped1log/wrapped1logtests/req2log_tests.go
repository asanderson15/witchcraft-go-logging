	...
	return []Req2TestCase{
		{
			...
			JSONMatcher: map[string]objmatcher.Matcher{
				...
				"payload": objmatcher.MapMatcher(map[string]objmatcher.Matcher{
					"type": objmatcher.NewEqualsMatcher("requestLogV2"),
					"requestLogV2": objmatcher.MapMatcher(map[string]objmatcher.Matcher{
...
func Req2LogJSONTestSuite(t *testing.T, entityName, entityVersion string, loggerProvider func(w io.Writer, params ...req2log.LoggerCreatorParam) req2log.Logger) {
	req2LogJSONOutputTests(t, entityName, entityVersion, loggerProvider)
}

func req2LogJSONOutputTests(t *testing.T, entityName, entityVersion string, loggerProvider func(w io.Writer, params ...req2log.LoggerCreatorParam) req2log.Logger) {
	for i, tc := range Req2TestCases(entityName, entityVersion) {
